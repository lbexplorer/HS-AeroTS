# P9 Stage 1 与端到端定位专项复核（2026-09-06）
...
| 方案 | 检测召回 | Top-1 | Top-3 | Top-5 | MRR | baseline 报警 |
| --- | --- | --- | --- | --- | --- | --- |
| 历史 P9 | 0/12 | 0/12 | 0/12 | 0/12 | 0.0000 | 0/12 |
| 本地输入，保留尾段（不推荐） | 11/12 | 2/12 | 5/12 | 5/12 | 0.3243 | 11/12 |
| 本地输入 + 有效时间覆盖（主结果） | 10/12 | 2/12 | 5/12 | 5/12 | 0.3259 | 10/12 |
| 正常 baseline 校准 + 连续 3 窗（消融） | 3/12 | 0/12 | 1/12 | 2/12 | 0.0583 | 4/12 |
...
| mutation_id | detected | top1 | top3 | top5 | mrr |
| --- | --- | --- | --- | --- | --- |
| Commander | 1.0000 | 0.0000 | 1.0000 | 1.0000 | 0.5000 |
| EKF2 | 0.6667 | 0.6667 | 0.6667 | 0.6667 | 0.6667 |
| INAV | 0.6667 | 0.0000 | 0.0000 | 0.0000 | 0.0648 |
| Land Detector | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0722 |

### 逐 run 变化

| mutation | 源日志 | 旧门控排名 | 新门控排名 | 检测 | 有效窗最高分 | publisher-only排名 | 原效应检查 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Commander | 2019-01-18__08_39_38 | 未检出 | 2 | 是 | 0.9822 | 1 | 未通过 |
| Commander | 2019-01-25__17_38_05 | 未检出 | 2 | 是 | 0.4899 | 1 | 通过 |
| Commander | 2019-03-06__08_02_26 | 未检出 | 2 | 是 | 0.7306 | 37 | 通过 |
| EKF2 | 2019-01-18__08_39_38 | 未检出 | 1 | 是 | 0.7388 | 2 | 通过 |
| EKF2 | 2019-01-25__17_38_05 | 未检出 | 不可用 | 否 | 0.1067 | 不可用 | 通过 |
| EKF2 | 2019-03-06__08_02_26 | 未检出 | 1 | 是 | 0.6860 | 1 | 通过 |
| INAV | 2019-01-18__08_39_38 | 未检出 | 12 | 是 | 0.8885 | 7 | 通过 |
| INAV | 2019-01-25__17_38_05 | 未检出 | 不可用 | 否 | 0.1257 | 不可用 | 通过 |
| INAV | 2019-03-06__08_02_26 | 未检出 | 9 | 是 | 0.6409 | 5 | 通过 |
| Land Detector | 2019-01-18__08_39_38 | 未检出 | 20 | 是 | 0.9807 | 不可用 | 通过 |
| Land Detector | 2019-01-25__17_38_05 | 未检出 | 6 | 是 | 0.4620 | 不可用 | 通过 |
| Land Detector | 2019-03-06__08_02_26 | 未检出 | 不可用 | 是 | 0.7139 | 不可用 | 通过 |
...
原效应检查 11/12 通过。只在附加敏感性中去掉上述未通过的 Commander 条件：检测 **9/11**，Top-1/3/5 = **2/11、4/11、4/11**，MRR = **0.3101**。主表仍保留全部 12 条，阈值与预测不因该筛选重新拟合。不可把这次重跑描述为“12/12 效应检查全部通过”。
