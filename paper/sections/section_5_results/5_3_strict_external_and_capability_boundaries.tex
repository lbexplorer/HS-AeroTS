...
\begin{table}[H]
\caption{Principal absolute metrics with model-seed standard deviation and 95\% cluster-bootstrap sampling intervals (1000 repetitions; seed 20260825). UAV-SEAD intervals resample complete test flight logs, ALFA resamples sequences, and Uncategorized resamples flights.\label{tab:absolute_uncertainty}}
\centering
\scriptsize
\begin{tabularx}{\textwidth}{l l c c c}
\toprule
\textbf{Dataset/protocol} & \textbf{Metric} & \textbf{Point estimate} & \textbf{Seed SD} & \textbf{95\% cluster CI}\\
\midrule
UAV-SEAD fixed & Stage 1 AUPRC & 0.7522 & 0.0039 & [0.6915, 0.8080]\\
UAV-SEAD fixed & Stage 2 Macro-F1 & 0.8980 & 0.0020 & [0.8581, 0.9296]\\
UAV-SEAD fixed & Cascade Macro-F1 & 0.6902 & 0.0071 & [0.6308, 0.7350]\\
UAV-SEAD fixed & Direct Five-Class Macro-F1 & 0.6599 & 0.0029 & [0.5991, 0.7070]\\
UAV-SEAD purged & Stage 1 AUPRC & 0.6006 & 0.0062 & [0.4968, 0.7109]\\
UAV-SEAD purged & Stage 2 Macro-F1 & 0.7944 & 0.0049 & [0.7040, 0.8489]\\
UAV-SEAD purged & Cascade Macro-F1 & 0.5683 & 0.0177 & [0.4532, 0.6338]\\
UAV-SEAD purged & Direct Five-Class Macro-F1 & 0.6024 & 0.0049 & [0.4890, 0.6664]\\
UAV-SEAD leave-log-out & Stage 1 AUPRC & 0.6296 & 0.0023 & [0.4945, 0.7456]\\
UAV-SEAD leave-log-out & Stage 2 Macro-F1 & 0.9041 & 0.0029 & [0.8276, 0.9549]\\
UAV-SEAD leave-log-out & Cascade Macro-F1 & 0.5962 & 0.0048 & [0.4889, 0.6799]\\
UAV-SEAD leave-log-out & Direct Five-Class Macro-F1 & 0.6092 & 0.0043 & [0.5091, 0.6836]\\
ALFA zero-shot & Stage 1 AUPRC & 0.3181 & 0.0086 & [0.2540, 0.3956]\\
Uncategorized screening & Flight-level AUPRC & 0.2784 & 0.0046 & [0.2086, 0.3664]\\
\bottomrule
\end{tabularx}
\end{table}
